    ...
    public partial class CreateDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Filmes_Id, t.Locacao_Id })
                .ForeignKey("dbo.Locacao", t => t.Filmes_Id, cascadeDelete: true)
                .ForeignKey("dbo.Filmes", t => t.Locacao_Id, cascadeDelete: true)
                .Index(t => t.Filmes_Id)
        ...
        {
            DropForeignKey("dbo.locacao_filmes", "Locacao_Id", "dbo.Filmes");
            DropForeignKey("dbo.locacao_filmes", "Filmes_Id", "dbo.Locacao");
